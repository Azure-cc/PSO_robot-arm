...
Using the swarm intelligence of PSO algorithm, the angle of each joint is automatically calculated to accurately grasp the target, so that the manipulator can accurately ' grab ' the target ball.
​​
...
If you want to know more about the principle of system implementation, welcome to visit my personal blog.【CSDN_枫叶机关录：https://blog.csdn.net/Azurel_?spm=1000.2115.3001.5343】
